...
public class ControlLoopOperationManager implements Serializable {
	...
	public Object startOperation(ControlLoopEvent onset) throws AAIException {
		return startOperation(onset, null);
	}

	public Object startOperation(/*VirtualControlLoopEvent*/ControlLoopEvent onset, WorkingMemory wm) throws AAIException {
		//
		...
		case "SO":
			...
			this.operationRequest = SOAsp.constructRequest((VirtualControlLoopEvent)onset, operation.operation, this.policy, wm);
